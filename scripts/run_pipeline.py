...
Main workflow script to run the entire F1 data pipeline
"""
...
def run_full_pipeline(start_year=2005, end_year=2024, skip_extract=False, skip_transform=False, skip_load=False):
